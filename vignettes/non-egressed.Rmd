...
(In future, this mechanism may also work with private S3 credentials in a 'requester-pays' model, charging for data egress rather than compute.  For more context on access mechanisms for NASA EarthData see the [motivations](motivations) vignette). 
