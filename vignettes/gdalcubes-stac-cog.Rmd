...
Same code with larger search box (10 degree x 10 degree)


```r
bbox <- c(xmin=-122.5, ymin=34, xmax=-112.5, ymax=44) 
...
items <- stac("https://cmr.earthdata.nasa.gov/stac/LPCLOUD") |> 
  ...
  items_fetch() |>
  items_filter(filter_fn = \(x) {x[["eo:cloud_cover"]] < 20})
#> Error: HTTP status '500'. If the problem persists please contact cmr-support@earthdata.nasa.gov
```
