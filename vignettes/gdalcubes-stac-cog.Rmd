...
#> Warning in stac_image_collection(items$features, asset_names = c("B02", : STAC asset with name 'B02' does not include eo:bands metadata and will be considered as a single band source
#> Warning in stac_image_collection(items$features, asset_names = c("B02", : STAC asset with name 'B03' does not include eo:bands metadata and will be considered as a single band source
#> Warning in stac_image_collection(items$features, asset_names = c("B02", : STAC asset with name 'B04' does not include eo:bands metadata and will be considered as a single band source
#> Warning in stac_image_collection(items$features, asset_names = c("B02", : STAC asset with name 'Fmask' does not include eo:bands metadata and will be considered as a single band source
```
...
![plot of chunk unnamed-chunk-6](imgunnamed-chunk-6-1.png)
